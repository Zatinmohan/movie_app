...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<SearchResultEntity> data});
}
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl({required final List<SearchResultEntity> data})
      : _data = data;

  final List<SearchResultEntity> _data;
  @override
  List<SearchResultEntity> get data {
...
abstract class _Loaded implements SearchState {
  const factory _Loaded({required final List<SearchResultEntity> data}) =
      _$LoadedImpl;
